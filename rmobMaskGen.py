...
if __name__ == "__main__":
	...
	print "otevírání souboru" + config.path +"/"+ config.path_data + "."
	...
	try:
		monthDataMask = np.load(config.path + "/" + config.path_data + "/" + config.Station + "_" + config.UserName + str(year) + "_" +str(month)+".npy")
	except Exception, e:
