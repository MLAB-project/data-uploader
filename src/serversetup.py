...
server_path =  "/storage/ionozor/VLF/"
...
def main():
	...
	if config.Version is "Bolidozor_14" or config.Version is "RadObs_14_7":
		if not existsfile(config.UserSpace + "@space.astro.cz", server_path + config.UserSpace + "/" +   config.StationSpace + "/"):
			...
			createfile(config.UserSpace + "@space.astro.cz", server_path + config.UserSpace + "/" +   config.StationSpace + "/" + config.path_data)
		else:
			print "slozka " + config.path_data + " existuje"
		if not existsfile(config.UserSpace + "@space.astro.cz", server_path + config.UserSpace + "/" +   config.StationSpace + "/"+ config.path_image):
			...
			createfile(config.UserSpace + "@space.astro.cz", server_path + config.UserSpace + "/" +   config.StationSpace + "/"+ config.path_image)
		else:
			print "slozka " + config.path_image + " existuje"
		if not existsfile(config.UserSpace + "@space.astro.cz", server_path + config.UserSpace + "/" +   config.StationSpace + "/"+ config.path_audio):
			...
			createfile(config.UserSpace + "@space.astro.cz", server_path + config.UserSpace + "/" +   config.StationSpace + "/"+ config.path_audio)
		else:
